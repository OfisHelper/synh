...
const response_text = `<center><h2 style="::selection {
    background-color: #000000;
    color: #ffffff;
}
;font-weight: 600; font-size: 3vw; color:white;">Résultat :</h2></center><br><div style="color:white; font-size: 20px;">${result}</div>`;
