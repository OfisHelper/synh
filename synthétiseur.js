...
app.post('/generate', (req, res) => {
    ...
    request(options, (err, response, body) => {
      ...
      const response_text = '<center><h2 style="font-weight: 600; font-size: 2vw; color:white;>Résultat :</h2"></center><br><p style="color:white; font-size: 20px;">'+ body.choices[0].message.content +'</p>';
