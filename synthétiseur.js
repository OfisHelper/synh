...
app.post('/generate', (req, res) => {
    ...
    request(options, (err, response, body) => {
        ...
        const response_text = `<center><h2 style="font-weight: 600; font-size: 3vw; color:white;">Résultat :</h2></center><br><div style="font-size: 20px;"><svg><text style="fill: white;"> gg + ${result}</text></svg></div>`;
